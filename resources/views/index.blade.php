                    ...
                    <div class="col-lg-3 text-right col-md-3">
                        <ul class="nav-right">
                            ...
                            <li class="cart-icon"><a href="#">
                                    ...
                                    <span id="total-quantity-show">{{Cart::session('test')->getTotalQuantity()}}</span>
                                    @else
                                ...
                                <div class="cart-hover">
                                    <div class="mini-cart">
                                        ...
                                        <div class="select-items">
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <td class="si-pic"><img width="70px"
                                    ...
                                    <div class="select-button">
                                        <a href="/list" class="primary-btn view-card">VIEW CARD</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    <div class="pi-pic">
                                        <img src="assets/img/products/{{$product->image}}" alt="logo">
                                        ...
                                        <ul>
                                            ...
                                            <li class="quick-view"><a onclick="AddCart({{$product->id}})"
                                                ...
                                                {{-- <li class="quick-view"><a href="/Add-Cart/{{$product->id}}">+ Add
                                                Cart</a> --}}
                                            </li>
        ...
        function AddCart(id) {
            $.ajax({
                ...
                success: function (res) {
                    RenderCart(res);
                    toastr.success('Added new item success', 'Congratulation !');
                }
            });
        }

        $('.mini-cart').on('click', '.si-close i', function () {
            $.ajax({
                type: "GET",
                url: "Remove-Cart/" + $(this).data('id'),
                success: function (res) {
                RenderCart(res);
                toastr.success('Removed item success', 'Congratulation !');
                }
            });
        });
    </script>
